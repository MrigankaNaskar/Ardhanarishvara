...
from security.validation import validate_manifest_dataframe
...
def load_real_abide_phenotypic() -> pd.DataFrame:
    """Fetch authentic ABIDE-I phenotypic data using Nilearn dataset fetcher."""
